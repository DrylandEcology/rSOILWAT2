...
setMethod(f="swWriteLines",signature=c(object="swInputData",file="character"), definition=function(object,file) {
			projectFolder <- dirname(file)
			object@files@ProjDir <- projectFolder
			object@files@InFiles[1] <- basename(file)
			swWriteLines(object@files,file)
			dir.create(dirname(file.path(projectFolder,object@files@InFiles[2])),showWarnings=FALSE, recursive=TRUE)
			swWriteLines(object@years,file.path(projectFolder,object@files@InFiles[2]))
			dir.create(dirname(file.path(projectFolder,object@files@InFiles[6])),showWarnings=FALSE, recursive=TRUE)
			swWriteLines(object@weather,file.path(projectFolder,object@files@InFiles[6]))
			dir.create(dirname(file.path(projectFolder,object@files@InFiles[9])),showWarnings=FALSE, recursive=TRUE)
			swWriteLines(object@cloud,file.path(projectFolder,object@files@InFiles[9]))
			#swWriteLines(object@weatherHistory,file.path(projectFolder,dirname(object@files@WeatherPrefix)))
			#swWriteLines(object@markov,file.path(projectFolder,object@files@InFiles[2]))
			dir.create(dirname(file.path(projectFolder,object@files@InFiles[10])),showWarnings=FALSE, recursive=TRUE)
			swWriteLines(object@prod,file.path(projectFolder,object@files@InFiles[10]))
			dir.create(dirname(file.path(projectFolder,object@files@InFiles[4])),showWarnings=FALSE, recursive=TRUE)
			swWriteLines(object@site,file.path(projectFolder,object@files@InFiles[4]))
			dir.create(dirname(file.path(projectFolder,object@files@InFiles[5])),showWarnings=FALSE, recursive=TRUE)
			swWriteLines(object@soils,file.path(projectFolder,object@files@InFiles[5]))
			dir.create(dirname(file.path(projectFolder,object@files@InFiles[11])),showWarnings=FALSE, recursive=TRUE)
			swWriteLines(object@estab,file.path(projectFolder,object@files@InFiles[11]))
			dir.create(dirname(file.path(projectFolder,object@files@InFiles[13])),showWarnings=FALSE, recursive=TRUE)
			swWriteLines(object@output,file.path(projectFolder,object@files@InFiles[13]))
			dir.create(dirname(file.path(projectFolder,object@files@InFiles[12])),showWarnings=FALSE, recursive=TRUE)
			swWriteLines(object@swc,file.path(projectFolder,object@files@InFiles[12]))
			#swWriteLines(object@log,file.path(projectFolder,object@files@InFiles[3]))
})
