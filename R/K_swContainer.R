...
setMethod("swYears_StartYear", "swInputData", function(object) {return(object@years@EDOEY)})
setMethod("swYears_StartYear", "swInputData", function(object) {return(object@years@isNorth)})
