...
setMethod("swCarbon_Historical_Bio","swInputData",function(object) {return(object@carbon@CarbonHistoricalBio)})
setMethod("swCarbon_Historical_Sto","swInputData",function(object) {return(object@carbon@CarbonHistoricalSto)})
...
setReplaceMethod(f="swCarbon_Historical_Bio",signature=c(object="swInputData", value="integer"),function(object, value) {object@carbon@CarbonHistoricalBio <- value; return(object)})
setReplaceMethod(f="swCarbon_Historical_Sto",signature=c(object="swInputData", value="integer"),function(object, value) {object@carbon@CarbonHistoricalSto <- value; return(object)})
