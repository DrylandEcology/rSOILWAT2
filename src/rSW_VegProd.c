...
SEXP onGet_SW_VPD(void) {
    ...
    /* Get values for slot 3: CanopyHeight */
    ...
    /* Get values for slot 4: VegetationInterceptionParameters */
    ...
    /* Get values for slot 5: LitterInterceptionParameters */
    ...
    /* Get values for slot 6: EsTpartitioning_param */
    ...
    /* Get values for slot 7: Es_param_limit */
    ...
    /* Get values for slot 9: HydraulicRedistribution_use */
    ...
    /* Get values for slot 10: HydraulicRedistribution */
    ...
    /* Get values for slot 11: CriticalSoilWaterPotential */
    ...
    /* Get values for slot 12: MonthlyVeg */
    ...
    /* Get values for slot 13: CO2Coefficients */
    ...
    /* Get values for slot 14: vegYear */
    PROTECT(VegYear = NEW_INTEGER(1));
    INTEGER(VegYear)[0] = vi->vegYear;


    /* Get values for slot 15: isBiomAsIf100Cover */
...
void onSet_SW_VPD(SEXP SW_VPD, LOG_INFO* LogInfo) {
    ...
    /* Set values using slot 2: Albedo */
    ...
    /* Set values using slot 3: CanopyHeight */
    ...
    /* Set values using slot 4: VegetationInterceptionParameters */
    ...
    /* Set values using slot 5: LitterInterceptionParameters */
    ...
    /* Set values using slot 6: EsTpartitioning_param */
    ...
    /* Set values using slot 7: Es_param_limit */
    ...
    /* Set values using slot 9: HydraulicRedistribution_use */
    ...
    /* Set values using slot 10: HydraulicRedistribution */
    ...
    /* Set values using slot 11: CriticalSoilWaterPotential */
    ...
    /* Set values using slot 12: MonthlyVeg */
    ...
    /* Set values using slot 13: CO2Coefficients */
