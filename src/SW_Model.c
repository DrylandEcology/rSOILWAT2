...
SEXP onGet_SW_MDL() {
	...
	//SET_VECTOR_ELT(SW_MDL, 4, DayMid);

	//PROTECT(SW_MDL_names = allocVector(STRSXP, 6));
	//for (i = 0; i < 6; i++)
		//SET_STRING_ELT(SW_MDL_names, i, mkChar(cSW_MDL_names[i]));
	//setAttrib(SW_MDL, R_NamesSymbol, SW_MDL_names);
