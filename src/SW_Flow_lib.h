...
void pot_soil_evap( double *bserate, unsigned int nelyrs, double ecoeff[],
                    ...
                    double range, double width[],  double swc[], double Es_param_limit);
...
void evap_litter_veg_surfaceWater( double *cwlit, double *cwstcr, double *standingWater, double *wevap,
									double *aet, double petday);
...
void remove_from_soil( double swc[],    double qty[], double *aet,
                       unsigned int nlyrs,
                       double ecoeff[], double rate,  double swcmin[]);
