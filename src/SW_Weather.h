...
typedef struct {
  /* comes from markov weather day-to-day */
    RealD temp_avg     [TWO_DAYS],
          temp_run_avg [TWO_DAYS],
          temp_yr_avg,             /* year's avg for STEPPE */
          temp_max     [TWO_DAYS],
          temp_min     [TWO_DAYS],
          ppt          [TWO_DAYS],	/* 20091015 (drs) ppt is divided into rain and snow */
          rain			[TWO_DAYS],
          snow			[TWO_DAYS],
          snowmelt		[TWO_DAYS],
          snowloss		[TWO_DAYS],
          ppt_actual   [TWO_DAYS],	/* 20091015 (drs) was here previously, but not used in code as of today */
...
typedef struct {
      RealD temp_max,
            temp_min,
            temp_avg,
            ppt, rain, snow, snowmelt, snowloss,	/* 20091015 (drs) ppt is divided into rain and snow */
            snowRunoff, surfaceRunoff, soil_inf,
            et, aet, pet;
} SW_WEATHER_OUTPUTS;
...
typedef struct {
    ...
    RealD	snowRunoff, surfaceRunoff,
			soil_inf;
